...
<font color="red">**DO NOT INCLUDE R CODE OR OUTPUT IN YOUR SOLUTIONS** *All R code can be included in an appendix, and R outputs should be converted to nicely formatted tables. Feel free to use R packages such as `kable`, `xtable`, and `stargazer`.*</font>
