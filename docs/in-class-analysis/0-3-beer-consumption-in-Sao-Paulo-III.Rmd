...
# Exercises
Continue with the linear model for `log(beer_cons_liters)` using `weekend`, `precip_mm`, and `temp_median_c` as your predictors.

1. Are there any (potential) outliers, leverage points or influential points?

2. Time to try to address the issues with the `precip_mm` variable. Create a 
